                ...
                <div class="col-lg-10">
                    ...
                    <div class="main-menu">
                        ...
                        <!--    <li><a href="#">blog</a>
                            ...
                            <li class="menu-btn">
                                <a href="latestOffers.jsp" class="button button2">Book Now</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-6 offset-xl-6 col-lg-7 offset-lg-5">
                    <div class="banner-text">
                        ...
                        <div class="banner-btn ml-xl-5 ">
                            <a href="login.jsp" class="button button2">SignUp/Login</a>
                        </div>
                       <!-- <div class="banner-btn ml-xl-5 ">
                            <a href="login.jsp" class="button button2">Login</a>
                        </div>-->
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 align-self-center mb-5 mb-lg-0">
                    ...
                    <a href="learnOffer.jsp" class="button button2">learn more</a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="bmi-text">
                        ...
                        <form action="CaculateBMI.jsp" id="bmi">
                            <div class="form-group">
                                <!--<label for="age">your age:</label>-->
                               your age: <input type="text" id="age">
                            </div>
                            <div class="form-group">
                                <!--<label for="wight">your weight:</label>-->
                               your weight in kg: <input class="calculations" type="text" name="weight" size="10" max="4">
                            </div>
                            <div class="form-group">
                                <!--<label for="height">your height:</label>-->
                                your height in cm:<input class="calculations" type="text" name="height" size="10">
                            </div>
                            <div class="form-group">
                                <!--<label for="gender">your gender:</label>-->
                                your gender:<input type="text" id="gender">
                            </div>
                            <div class="form-group">
                                <!--<label for="bmi">your bmi is:</label>-->
                                your bmi is:<input name="BMI" class="calculations" type="text" id="dopeBMI" size="10" readonly>
                            </div>
                            <%--<% System.out.println("<script>alert(\"you have to do pushup's for better bidy result\");</script>");%>--%>
                            <div class="bmi-btn pt-4">
                                <input class="button button2" type="submit" id="calculateBMI" name="verify" value="What is bmi"><a href="CalculateBMI.jsp"></a>
                            </div>
