...
input[type=radio]
{
    ...
    <div class="section-top text-center">
        <h3><font color="#003d99" type="bold" size="7px">Admin Registration</font></h3>
    </div>
    <div class="left">
    <form action="AdminRegistrationConfirm.jsp">
    <table align="center" cellpadding="10">
    <tr><td><font color="red" type="bold" size="5px">NAME:</td>
    ...
    <tr><td> <font color="red" type="bold" size="5px">CONTACT NO.:</font> </td><td><input type="text" placeholder="Enter number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter mobile no'" required name="mobile"></td>
     </tr>
     </div>
     <div class="right">
         <tr><td><font color="red" type="bold" size="5px">ADDRESS:</font> </td><td><textarea name="message" cols="20" rows="7"  placeholder="Enter Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" required name="address"></textarea></td></tr>
    </div>
        ...
        <tr><td> <font color="red" type="bold" size="5px">User Type:</font> </td><td>
    <select name="U_Type">
    <option value="Admin">Admin</option>
    <option value="Trainer">Trainer</option>
    <option value="Member">Member</option>
    </select></td></tr>
    <tr><td> <input type="submit" class="button1 button4" name="submit" value="Register"></td></tr>
    </table>
    </form>
</div>
    </div>
