...
<!--                            <li><a href="#">blog</a>
                            ...
                            <li class="menu-btn">
                                <a href="latestOffers.jsp" class="template-btn">Latest Offer</a>
                            </li>
                        </ul>
                    </div>
                </div>
				...
				<div class="table-wrap col-lg-10">
					<table class="schdule-table table">
						...
						<tbody>
							...
							<tr>
								<th class="name" scope="row">FreeElectricsWorkout</th>
								<td>02.00</td>
								<td>10.00</td>
								<td>02.00</td>
								<td>02.00</td>
							...
							<tr>
								<th class="name" scope="row">Stretching</th>
								<td>02.00</td>
								<td>10.00</td>
								<td>02.00</td>
								<td>02.00</td>
							...
							<tr>
								<th class="name" scope="row">ArmStretching</th>
								<td>02.00</td>
								<td>10.00</td>
								<td>02.00</td>
								<td>02.00</td>
